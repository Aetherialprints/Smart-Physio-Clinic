...
CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ORIGINS', 'http://localhost:3000,https://aetherialprints.com,https://www.aetherialprints.com,http://aetherialprints.com').split(',')
